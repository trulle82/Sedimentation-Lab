...
There are several alternatives to run this lab. You can download it locally to your computer if you have Python installed (together with numpy, jupyter, etc). 
Or you can run it by clicking the binder button on this page (takes some time to load though). You can also run it in Google Colab, CoCalc, Saturn Cloud, or similar. 
